...
pub trait Adapter: Send + Sync {
  ...
  fn post(&self, data: &JsonObject, params: &JsonObject) -> BoxFuture<JsonValue, (ErrorKind, JsonValue)>;
  fn patch(&self, id: &str, data: &JsonObject, params: &JsonObject) -> BoxFuture<JsonValue, (ErrorKind, JsonValue)>;
